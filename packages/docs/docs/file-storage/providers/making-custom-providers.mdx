...
sidebar_position: 1
---
# Making Custom Providers

import CodeSnippet from '../../CodeSnippet';

## Introduction

Custom providers are extensions of [multer compatible `storage engines`](https://github.com/expressjs/multer/blob/master/StorageEngine.md)
