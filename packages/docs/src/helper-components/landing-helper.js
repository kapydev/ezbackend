  ...
  return (
    <>
      <div className="col-span-full py-8 flex justify-center">
        <div className="text-2xl font-mono font-bold">Low Code Backend</div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 place-items-center self-center col-span-full transform md:scale-90">
        ...
        <div className="sm:grid col-span-full sm:col-span-1 place-items-center w-full self-start hidden ">
          <div className="w-full">
            ...
            <StepFeature delay={4000}>Database Connection Made</StepFeature>
            <StepFeature delay={4500}>
              <span className="text-purple">Pets</span> Table Created in
              Database
            </StepFeature>
            <StepFeature delay={9000}>Table Columns Added</StepFeature>
            <StepFeature delay={12900}>CRUD Endpoints Generated</StepFeature>
            <StepFeature delay={15000}>API Documentation Generated</StepFeature>
      ...
      <div className="col-span-full py-12 flex justify-center">
        <div className="text-2xl font-mono font-bold">Everything You Need</div>
      </div>
          ...
          <AccordionPanel id="scale">
            ...
            <ol type="1">
              <li className="mb-2">
                ...
                EzDeploy's reverse proxy for load balancing. The reverse proxy
                also serves as an additional layer of security by providing SSL
                encryption and hiding actual servers from the internet
              </li>
              <li className="mb-2">
                Stateless Servers - EzBackend is designed in principle to be
                completely stateless, allowing you to scale across regions by
                creating new EzBackend instances
              </li>
              <li className="mb-2">
                [COMING SOON] Read Replicas. By creating read-replicas in the
                same Virtual Private Cloud as your EzBackend instances, the
                end-user can receive low-latency regardless of region.
              </li>
              <li className="mb-2">
                [COMING SOON] Adapters. EzBackend comes "batteries included"
                with adapters to manage realtime updates with socket.io and
                other operations that require action on all EzBackend instances
              </li>
            </ol>
            <p className="text-xl">Caveats:</p>
            <ol type="1">
              <li className="mb-2">
                Write operations. There are currently no plans for EzBackend to
                scale for write operations, but research is being done to scale
                postgres writes with cross-region database sharding and
                writeback caching wrappers
              </li>
              <li className="mb-2">
                Replication lag. When reads are performed to a replica at the
                same time a write to the main postgres instance occurs, the
                information read out may not be fully accurate. In scenarios
                where data accuracy is paramount, EzBackend reads can be
                configured to read from the main postgres instance instead.
              </li>
            </ol>
          </AccordionPanel>
        </Accordion>
