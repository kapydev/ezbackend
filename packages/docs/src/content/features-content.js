...
export const features_content = [
    {
        ...
        media: null,
        released: true,
        flip_card: <div>Common functionality is replaced with minimal code in EzBackend. In <span className='text-purple'>5 lines of code</span> you can add a DB table with CRUD Endpoints</div>,
    },
    {
        ...
        media: null,
        released: true,
        flip_card: <div>Ezbackend un-apologetically <span className='text-purple'>uses fastify</span> under the hood, to ensure your users experience minimal latency</div>,
    },
    {
...

    {
        ...
        media: null,
        released: true,
        flip_card: <div>EzBackend automatically <span className="text-purple">infers types</span> as much as possible, meaning <span className="text-purple">less time spent defining typescript types</span> and more time writing business logic</div>,
    },
...

    {
        ...
        media: null,
        released: true,
        flip_card: <div>The in-built database-agnoistic DB editor allows you to <span className="text-purple">quickly populate and edit</span> test data. No need for external tools such DBeaver to insert test data.</div>,
    },
    {
        ...
        media: null,
        released: false,
        flip_card: <div>EzBackend requires <span className="text-purple">minimal configuration changes</span> between a simple app for casual use and a <span className="text-purple">Leviathan-scale</span> app that scales horizontally to serve millions</div>,
    },

    {
        ...
        media: null,
        released: false,
        flip_card: <div> <span className='italic'>COMING SOON</span> <br />Listen to database updates in realtime. Comes with <span className="text-purple">packet level security</span> where read/write permissions for each recepient is verified before socket.io packets are sent.</div>,
    },

    {
        ...
        media: null,
        released: false,
        flip_card: <div><span className='italic'>COMING SOON</span> <br />Store files in blob-storage</div>
    },
